...
class BezRucke extends React.Component{
   componentDidMount(){
   ...
   Proizvodi(){
       return this.props.proizvodi.map(proizvod=>{
           if(proizvod.kategorija==="pk bez rucke"){
                return(
                    <div key={proizvod.id}>
                        ...
                        <nav className="navbar navbar-expand-lg navbar-light d-flex justify-content-end pt-4" > 
                            ...
                            <ul className="navbar-nav ml-3" id="navbar" >
                                ...
                                <div className="dropdown-menu p-0" id="dropdown-item" aria-labelledby="navbarDropdown">
                                    ...
                                    <hr className="m-0 p-0"/>
                                    <Link className="dropdown-item" id="active" to="/papirnekesebezrucke">BEZ RUČKE</Link>
                                </div>
                                </li>
                                <li className="nav-item navItem">
...
export default connect(mapStateToProps, {fetchPosts})(BezRucke)