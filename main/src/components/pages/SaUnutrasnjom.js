...
class SaUnutrasnjom extends React.Component{
   componentDidMount(){
   ...
   Proizvodi(){
       return this.props.proizvodi.map(proizvod=>{
           if(proizvod.kategorija==="pk unutrasnja" ){
                return(
                    <div key={proizvod.id}>
    ...
    render(){
        ...
        return(
                <div className="wrapper">
                        ...
                        <nav className="navbar navbar-expand-lg navbar-light d-flex justify-content-end pt-4" > 
                            ...
                            <ul className="navbar-nav ml-3" id="navbar" >
                                ...
                                <div className="dropdown-menu p-0" id="dropdown-item" aria-labelledby="navbarDropdown">
                                    ...
                                    <Link className="dropdown-item pl-5 " id="active" to="/papirnekesesaunutrasnjomruckom">- UNUTRAŠNJOM</Link>
                    ...
                    <h1>Papirne kese sa ravnom unutrašnjom ručkom:</h1>
...
export default connect(mapStateToProps, {fetchPosts})(SaUnutrasnjom)