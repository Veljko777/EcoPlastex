...
class SaUpredenom extends React.Component{
   componentDidMount(){
   ...
   Proizvodi(){
       return this.props.proizvodi.map(proizvod=>{
           if(proizvod.kategorija==="pk upredena"){
                return(
                    <div key={proizvod.id}>
    ...
    render(){
        ...
        return(
                <div className="wrapper">
                        ...
                        <nav className="navbar navbar-expand-lg navbar-light d-flex justify-content-end pt-4" > 
                            ...
                            <ul className="navbar-nav ml-3" id="navbar" >
                                ...
                                <div className="dropdown-menu p-0" id="dropdown-item" aria-labelledby="navbarDropdown">
                                    ...
                                    <Link className="dropdown-item" id="active" to="/papirnekesesaupredenomruckom">SA UPREDENOM RUČKOM</Link>
                                    <hr className="m-0 p-0"/>
                    ...
                    <h1>Papirne kese sa upredenom ručkom:</h1>
...
export default connect(mapStateToProps, {fetchPosts})(SaUpredenom)