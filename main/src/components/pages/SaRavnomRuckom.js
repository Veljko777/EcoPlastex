...
class SaRavnomRuckom extends React.Component{
   componentDidMount(){
   ...
   Proizvodi(){
       return this.props.proizvodi.map(proizvod=>{
           if(proizvod.kategorija==="pk unutrasnja" || proizvod.kategorija==="pk spoljasnja"){
                return(
                    <div key={proizvod.id}>
                        ...
                        <div className="card-body">
                            <h5 className=" text-center">{proizvod.naziv}</h5>
    ...
    render(){
        ...
        return(
                <div className="wrapper">
                        ...
                        <nav className="navbar navbar-expand-lg navbar-light d-flex justify-content-end pt-4" > 
                            ...
                            <ul className="navbar-nav ml-3" id="navbar" >
                                ...
                                <div className="dropdown-menu p-0" id="dropdown-item" aria-labelledby="navbarDropdown">
                                    <Link className="dropdown-item" id="active" to="/papirnekesesaravnomruckom" >SA RAVNOM RUČKOM:</Link>
                    ...
                    <h1>Papirne kese sa ravnom ručkom:</h1>
...
export default connect(mapStateToProps, {fetchPosts})(SaRavnomRuckom)